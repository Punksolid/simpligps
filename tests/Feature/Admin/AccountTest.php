...
class AccountTest extends TestCase
{
    ...
    public function test_ecommerce_puede_crear_cuentas()
    {
        $this->withExceptionHandling();
        $user = factory(User::class)->make();
        $license = factory(License::class)->create();
        $hashed = Hash::make("1234567890");
        $form = [
                "billing" => [
                    "email" => $user->email
                ]
                ];
        $form["line_items"][0]["sku"] = $license->name;
        $call = $this->postJson("api/v1/ecommerce/1234567890", $form);
