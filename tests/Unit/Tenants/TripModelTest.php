...
class TripModelTest extends TestCase
{
    ...
    public function test_active_trip_by_interval_schedules_load_and_unload(): void
    {
        ...
        $trips_searched = Trip::with('checkpoints')->onlyOngoing()->get();
//        dd($trips_searched->toArray());
//        $trips_searched = Trip::betweenDates(Carbon::yesterday(), Carbon::now()->addDays(18))->get();
//        dd($trips_searched->toArray());
        $this->assertTrue($trips_searched->contains($ongoing_trip));
        $this->assertFalse($trips_searched->contains($PAST_TRIP));
    ...
    public function test_validateReferrals_throws_an_exception_if_incomplete()
    {
